...
lbl_identificacao = Label(frm_planoteste, text="Tipo de teste", font=("Arial", 50), bg="#00CED1", fg="white")
...
lbl_ferramenta = Label(frm_ferramenta, text="- Descrevas os tipos de teste para que o projeto seja concluído com sucesso", font=("Arial", 20), bg="#ced2d9")
...
lbl_campo1 = Label(frm_campos12, text="Objetivo da tecnica:", font=("Arial", 16), bg="#ced2d9")
...
lbl_campo2 = Label(frm_campos12, text="Tecnica:", font=("Arial", 16), bg="#ced2d9")
...
lbl_campo3 = Label(frm_campos34, text="Ferramentas Utilizadas:", font=("Arial", 16), bg="#ced2d9")
...
lbl_campo4 = Label(frm_campos34, text="Criterio de Exito:", font=("Arial", 16), bg="#ced2d9")
...
def inserir_dados():
    ...
    cursor.execute("INSERT INTO tipo_teste (id,campo1,campo2,campo3,campo4) VALUES (?, ?, ?, ?, ?)", (id,campo1,campo2,campo3,campo4))
...
def alterar_dados():
    ...
    cursor.execute("UPDATE tipo_teste SET campo1 = ?, campo2 = ?, campo3 = ?, campo4 = ? WHERE id = ?", (campo1,campo2,campo3,campo4,id))
...
def excluir_dados():
    ...
    cursor.execute("DELETE FROM tipo_teste WHERE id = ?", (id,))
...
def selecionar_dados():
    ...
    cursor.execute("SELECT * FROM tipo_teste WHERE id = ?", (id,))
    dados = cursor.fetchone()
    
    if dados:
        ent_campo1.delete(0, tk.END)
        ent_campo1.insert(tk.END, dados[1])
        
        ent_campo2.delete(0, tk.END)
        ent_campo2.insert(tk.END, dados[2])
        
        ent_campo3.delete(0, tk.END)
        ent_campo3.insert(tk.END, dados[3])

        ent_campo4.delete(0, tk.END)
        ent_campo4.insert(tk.END, dados[4])
