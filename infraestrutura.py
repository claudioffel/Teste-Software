...
lbl_identificacao = Label(frm_planoteste, text="Infraestrutura Necessária", font=("Arial", 50), bg="#00CED1", fg="white")
...
lbl_ferramenta = Label(frm_ferramenta, text="- Descrevas as infraestruturas para que o projeto seja concluído com sucesso",
                       font=("Arial", 20), bg="#ced2d9")
...
lbl_campo1 = Label(frm_campos12, text="1)", font=("Arial", 16), bg="#ced2d9")
...
lbl_campo2 = Label(frm_campos12, text="2)", font=("Arial", 16), bg="#ced2d9")
...
lbl_campo3 = Label(frm_campos34, text="3)", font=("Arial", 16), bg="#ced2d9")
...
lbl_campo4 = Label(frm_campos34, text="4)", font=("Arial", 16), bg="#ced2d9")
...
def inserir_dados():
    ...
    cursor.execute("INSERT INTO infraestrutura (campo1,campo2,campo3,campo4) VALUES (?, ?, ?, ?)", (campo1, campo2, campo3, campo4))
...
def excluir_dados():
    ...
    cursor.execute("DELETE FROM infraestrutura WHERE id=?", (id_exclusao,))
...
def atualizar_dados():
    ...
    cursor.execute("UPDATE infraestrutura SET campo1=?, campo2=?, campo3=?, campo4=? WHERE id=?", (campo1, campo2, campo3, campo4, id_atualizacao))
...
def select_dados():
    ...
    cursor.execute("SELECT * FROM infraestrutura WHERE id=?", (id_selecionado,))
