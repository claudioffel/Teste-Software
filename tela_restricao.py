...
lbl_identificacao = Label(frm_planoteste, text="Restrições", font=("Arial", 50), bg="#00CED1", fg="white")
...
lbl_ferramenta = Label(frm_ferramenta, text="- Descrevas as restrições para que o projeto seja concluído com sucesso", font=("Arial", 20), bg="#ced2d9")
...
def inserir_dados():
    ...
    cursor.execute("INSERT INTO restricoes (id,campo1,campo2,campo3,campo4) VALUES (?, ?, ?, ?, ?)", (id,campo1,campo2,campo3,campo4))
...
def alterar_dados():
    ...
    cursor.execute("UPDATE restricoes SET campo1 = ?, campo2 = ?, campo3 = ?, campo4 = ? WHERE id = ?", (campo1,campo2,campo3,campo4,id))
...
def excluir_dados():
    ...
    cursor.execute("DELETE FROM restricoes WHERE id = ?", (id,))
...
def selecionar_dados():
    ...
    cursor.execute("SELECT * FROM restricoes WHERE id = ?", (id,))
